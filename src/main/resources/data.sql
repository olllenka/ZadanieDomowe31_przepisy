...
INSERT INTO recipe (title, description, PREPARATION_TIME_IN_MINUTES, category_id, diet_id, difficulty_id, image) VALUES ('Tort czekoladowy', 'Upieczony biszkopt przełóż masą czekoladową', 60, SELECT id FROM category WHERE name = 'Deser', SELECT id FROM diet WHERE name = 'wegetariańska', SELECT id FROM difficulty WHERE name = 'średni', '/recipeImages/tort_czekoladowy.jpg');
INSERT INTO recipe (title, description, PREPARATION_TIME_IN_MINUTES, category_id, diet_id, difficulty_id, image) VALUES ('Tort malinowy', 'Upieczony biszkopt przełóż masą malinową', 120, SELECT id FROM category WHERE name = 'Deser', SELECT id FROM diet WHERE name = 'wegetariańska', SELECT id FROM difficulty WHERE name = 'ekspert', '/recipeImages/tort_malinowy.jpg');
INSERT INTO recipe (title, description, PREPARATION_TIME_IN_MINUTES, category_id, diet_id, difficulty_id, image) VALUES ('Sałatka grecka', 'Warzywa pokroić', 15, SELECT id FROM category WHERE name = 'Sałatka', SELECT id FROM diet WHERE name = 'wegetariańska', SELECT id FROM difficulty WHERE name = 'łatwy', '/recipeImages/salatka_grecka.jpg');
INSERT INTO recipe (title, description, PREPARATION_TIME_IN_MINUTES, category_id, diet_id, difficulty_id, image) VALUES ('Kotlet schabowy', 'Przygotowane mięso usmażyć', 45, SELECT id FROM category WHERE name = 'Danie główne', SELECT id FROM diet WHERE name = 'białkowa', SELECT id FROM difficulty WHERE name = 'trudny', '/recipeImages/kotlet_schabowy.jpg');
INSERT INTO recipe (title, description, PREPARATION_TIME_IN_MINUTES, category_id, diet_id, difficulty_id, image) VALUES ('Makaron z sosem', 'Makaron ugotować', 30, SELECT id FROM category WHERE name = 'danie proste', SELECT id FROM diet WHERE name = 'wegańska', SELECT id FROM difficulty WHERE name = 'trudny', '/recipeImages/makaron_z_sosem.jpg');
